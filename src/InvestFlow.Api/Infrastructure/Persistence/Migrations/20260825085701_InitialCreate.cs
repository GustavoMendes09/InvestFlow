        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "text", nullable: false),
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    AssetClass = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvestmentContributions_Investments_InvestmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvestmentContributions_InvestmentId",
                table: "InvestmentContributions",
                column: "InvestmentId");

            migrationBuilder.CreateIndex(
                name: "IX_MonthlySnapshots_UserId_Month",
